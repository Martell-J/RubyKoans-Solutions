...
class AboutSymbols < Neo::Koan
  ...
  # Comparing against 2 different Classes may lead to inconsistent comparisons, and
  # has a higher-potential for errors.
  ...
  # The allocated memory for symbols cannot be removed until the program finishes,
  # thus having a lot of potential to lead to memory leaks
