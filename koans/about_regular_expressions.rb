...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When the preceeding match-parameter is not met
  end
  ...
  # Seems repeition operators still succeed, even if it matches no characters.
  ...
  # It would seem that character classes are for managing and delegating (to variables) a more general search of characters,
  # whereas alternations are used to search for exact strings/characters.
